        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QRCodeConfig = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CheckedInTime = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    RegistationId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QRCodeScanLogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_QRCodeScanLogs_Registrations_RegistationId",
                        column: x => x.RegistationId,
                        principalTable: "Registrations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_QRCodeScanLogs_Users_ScannedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QRCodeScanLogs_RegistationId",
                table: "QRCodeScanLogs",
                column: "RegistationId");

            migrationBuilder.CreateIndex(
                name: "IX_QRCodeScanLogs_ScannedByUserId",
                table: "QRCodeScanLogs",
